...
const clearActions = () => {
	getCurrentTab().then((response) => {
		...
		actions = [
			...
			{ title: "Open Discord", desc: "Open Discord Webapp", type: "action", action: "url", url: "https://discord.com/app", emoji: false, favIconUrl: chrome.runtime.getURL("assets/logo-discord.png") },
			{ title: "Open Discord Doc", desc: "Open Discord API documentation", type: "action", action: "url", url: "https://discord.com/developers/docs/intro", emoji: false, favIconUrl: chrome.runtime.getURL("assets/logo-discord.png") },
			{ title: "Open Developer Portal", desc: "Open Discord Developer Portal", type: "action", action: "url", url: "https://discord.com/developers/applications", emoji: false, favIconUrl: chrome.runtime.getURL("assets/logo-discord.png") },
		];
